...
for i = 1:MC
    [VMR_2003(i,:),Mean_2003(i,:),Var_2003(i,:)] = Vector_TL_DF_square_mark(Data2003,Scale,1000) ;
    [VMR_2004(i,:),Mean_2004(i,:),Var_2004(i,:)] = Vector_TL_DF_square_mark(Data2004,Scale,1000) ;
    [VMR_2005(i,:),Mean_2005(i,:),Var_2005(i,:)] = Vector_TL_DF_square_mark(Data2005,Scale,1000) ;
    [VMR_2006(i,:),Mean_2006(i,:),Var_2006(i,:)] = Vector_TL_DF_square_mark(Data2006,Scale,1000) ;
    [VMR_2007(i,:),Mean_2007(i,:),Var_2007(i,:)] = Vector_TL_DF_square_mark(Data2007,Scale,1000) ;
end
